function [decoder, classifierEpochs] = computeDecoderLeft(trainEpochs, trainLabels, params)
% computeDecoderLeft trains a classifier to detect right-distractor trials 
...
elseif isequal(params.classify.normtype, 'zscore')
    avg = mean(classifierEpochs,2); % 52 x 1
    stdev = std(classifierEpochs,0,2); % 52 x 1
